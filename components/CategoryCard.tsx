...
export default function CategoryCard({
  ...
  return (
    <Link href={href}>
      ...
      >
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-linear-to-t from-primary via-primary/50 to-transparent opacity-75 group-hover:opacity-85 transition-opacity duration-300" />
