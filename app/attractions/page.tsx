...
export const metadata: Metadata = {
  title: 'Attractions in Fuvahmulah - Single Island Atoll Guide',
  description: 'Discover top attractions in Fuvahmulah including Thinadhoo Beach, Ukulhas, Felidhoo Lagoon, and more',
};
  ...
  return (
    <>
      ...
      <section className="section-container">
        ...
        <p className="section-subtitle">Must-Visit Destinations in Fuvahmulah</p>
      ...
      <section className="section-spacing bg-white">
        <div className="section-container">
          <div className="text-center mb-16">
            <h2 className="section-title mb-4">Fuvahmulah Island Tour</h2>
          ...
          <p className="text-center mt-8 text-gray-600 text-base">
            Take a visual journey through Fuvahmulah's most beautiful attractions, beaches, and natural wonders.
          </p>
        </div>
      </section>
      ...
      <section className="section-spacing bg-linear-to-b from-white to-blue-50">
        <div className="section-container">
          <div className="text-center mb-16">
            <h2 className="section-title mb-4">Nature & Wildlife</h2>
            <p className="section-subtitle">Experience Fuvahmulah's pristine ecosystem and incredible biodiversity</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card-elevated p-8 border-l-4 border-blue-500">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">🐢 Sea Turtles</h3>
              <p className="text-gray-700 mb-4 leading-relaxed">
                Fuvahmulah is known for sea turtle populations. You may encounter these gentle creatures while snorkeling or diving during certain seasons.
              </p>
              <p className="text-sm text-blue-600 font-semibold">✓ Best Season: March - November</p>
            </div>

            <div className="card-elevated p-8 border-l-4 border-green-500">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">🐠 Tropical Fish</h3>
              <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <p className="text-sm text-green-600 font-semibold">✓ Best For: Snorkeling & Diving</p>
            </div>

            <div className="card-elevated p-8 border-l-4 border-amber-500">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">🦑 Manta Rays & Mobulas</h3>
              <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <div className="card-elevated p-8 border-l-4 border-blue-500">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">🐠 Groupers & Snappers</h3>
              <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <p className="text-sm text-blue-600 font-semibold">✓ Best For: Fishing & Diving</p>
            </div>

            <div className="card-elevated p-8 border-l-4 border-teal-500">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">🐚 Coral & Mollusks</h3>
              <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <div className="card-elevated p-8 border-l-4 border-orange-500">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">🌅 Bird Watching</h3>
              <p className="text-gray-700 mb-4 leading-relaxed">
                Fuvahmulah attracts various seabirds. Spot frigatebirds, herons, and other species along the beaches.
              </p>
        ...
        <div className="section-container relative z-10">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/accommodation"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transform hover:scale-105 transition"
              >
                Book Accommodation
              </Link>
              <Link
